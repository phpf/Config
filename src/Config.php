...
class Config extends DataContainer
{
	...
	public function __unset($var) {
		...
		if ($this->isReadOnly()) {
			throw new RuntimeException("Cannot unset $var - config object is read-only.");
		}
	...
	public function setDefault($var, $val) {
		...
		if (! $this->hasDefaults()) {
			throw new RuntimeException("Config object may not have defaults. To use defaults, call setHasDefaults(true)");
		}
	...
	public function getDefault($var) {
		...
		if (! $this->hasDefaults()) {
			throw new RuntimeException("Config object does not have defaults.");
		}
